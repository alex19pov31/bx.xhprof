...
$adminList->AddHeaders([
    ...
    [
        'id' => 'AVG_IN_TIME',
        'content' => Loc::getMessage('avg_all_time_exec'),
        'sort' => 'avg_wt',
        'default' => true,
    ],
    [
    ...
    [
        'id' => 'AVG_EX_TIME',
        'content' => Loc::getMessage('avg_ex_time_exec'),
        'sort' => 'avg_ext_wt',
        'default' => true,
    ],
    [
        'id' => 'IN_CPU',
        'content' => Loc::getMessage('cpu_time_exec'),
        'sort' => 'cpu',
        'default' => true,
    ],
    [
        'id' => 'IN_CPU_P',
        'content' => Loc::getMessage('cpu_time_exec_percent'),
        'sort' => 'cpu_p',
        'default' => true,
    ],
    [
        'id' => 'AVG_IN_CPU',
        'content' => Loc::getMessage('avg_cpu_time_exec'),
        'sort' => 'avg_cpu',
        'default' => true,
    ],
    [
        'id' => 'EX_CPU',
        'content' => Loc::getMessage('cpu_ex_time_exec'),
        'sort' => 'ext_cpu',
        'default' => true,
    ],
    [
        'id' => 'EX_CPU_P',
        'content' => Loc::getMessage('cpu_ex_time_exec_percent'),
        'sort' => 'ext_cpu_p',
        'default' => true,
    ],
    [
        'id' => 'AVG_EX_CPU',
        'content' => Loc::getMessage('avg_cpu_ex_time_exec'),
        'sort' => 'avg_ext_cpu',
        'default' => true,
    ],
    [
    ...
    [
        'id' => 'AVG_IN_MEM',
        'content' => Loc::getMessage('avg_memory_usage'),
        'sort' => 'avg_mu',
        'default' => true,
    ],
    [
    ...
    [
        'id' => 'AVG_EX_MEM',
        'content' => Loc::getMessage('avg_ex_memory_usage'),
        'sort' => 'avg_ext_mu',
        'default' => true,
    ],
    [
